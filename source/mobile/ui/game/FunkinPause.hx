...
class FunkinPause extends FlxGroup
{
    ...
    public function new()
    {
        ...
        pauseButton.frames = flixel.graphics.frames.FlxAtlasFrames.fromSparrow(
            openfl.utils.Assets.getBitmapData("assets/mobile/pauseButton.png"), 
            openfl.utils.Assets.getText("assets/mobile/pauseButton.xml")
        );
